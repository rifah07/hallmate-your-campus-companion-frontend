...
export const mockApplications: Application[] = [
  { id: 'app1', studentId: '4', studentName: 'Anika Islam', studentAvatar: avatarUrl('Anika Islam'), type: 'NEW_SEAT', status: 'PENDING', roomPreferences: ['301', '302', '303'], reason: 'New admission, need accommodation.', documents: [], createdAt: '2024-06-01', updatedAt: '2024-06-01' },
  { id: 'app2', studentId: '5', studentName: 'Tasnia Haque', studentAvatar: avatarUrl('Tasnia Haque'), type: 'TRANSFER', status: 'APPROVED', roomPreferences: ['401'], reason: 'Want to be closer to classmates.', documents: [], adminNotes: 'Approved - room available.', createdAt: '2024-05-20', updatedAt: '2024-05-22' },
  { id: 'app3', studentId: '6', studentName: 'Raisa Kabir', studentAvatar: avatarUrl('Raisa Kabir'), type: 'NEW_SEAT', status: 'REJECTED', roomPreferences: ['201', '202'], reason: 'Final year, need single room.', documents: [], adminNotes: 'No single rooms available.', createdAt: '2024-05-15', updatedAt: '2024-05-17' },
  { id: 'app4', studentId: '14', studentName: 'Sadia Akter', studentAvatar: avatarUrl('Sadia Akter'), type: 'GUEST_ROOM', status: 'PENDING', roomPreferences: [], reason: 'Parents visiting for convocation.', documents: [], createdAt: '2024-06-10', updatedAt: '2024-06-10' },
  { id: 'app5', studentId: '15', studentName: 'Maryam Khan', studentAvatar: avatarUrl('Maryam Khan'), type: 'TRANSFER', status: 'PENDING', roomPreferences: ['305', '306'], reason: 'AC room needed for medical reasons.', documents: [], createdAt: '2024-06-12', updatedAt: '2024-06-12' },
];
